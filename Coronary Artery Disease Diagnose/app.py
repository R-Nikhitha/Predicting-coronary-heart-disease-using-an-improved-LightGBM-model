...
main = tk.Tk()
main.title("Predicting Coronary Heart Disease using Lightgbm Model") 
main.geometry("1600x1500")

font = ('times', 16, 'bold')
title = tk.Label(main, text='Detection of Ransomware Attacks using Processor and Disk Usage Data',font=("times"))
